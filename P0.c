...
int main(int argc, char* argv[])
{
  ...
  int flag1 = 0;
  int flag2 = 0;
  //int depth = -1;  // Keep track node depth
  ...
  if (flag1 == 1)
  {
    ...
    printf("\nPreorder traversal:\n");
    preOrder(root, "output.preorder", 0);
    printf("\nInorder traversal:\n");
    inOrder(root, "output.inorder", 0);
    printf("\nPostorder traversal:\n");
    postOrder(root, "output.postorder", 0);
  }

  if (flag2 == 1)
  {
    printf("\nPreorder traversal:\n");
    preOrder(root, combined2, 0);
    printf("\nInorder traversal:\n");
    inOrder(root, combined, 0);
    printf("\nPostorder traversal:\n");
    postOrder(root, combined3, 0);
  }
